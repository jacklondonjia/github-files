#ifndef __CUSTOMERL064002AA_H
#define __CUSTOMERL064002AA_H
...
#define	Number_Pole_Pairs		24		//电机极对数
...
#define AH_Battery		       	 		40
#define	BatteryStandardM				100000
#define	Rated_Q_Release_PerFrame_A		(12) //等于额定AH*额定速度/额定公里数
