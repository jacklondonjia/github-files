#ifndef __CUSTOMERL000001AC_H  
#define __CUSTOMERL000001AC_H
...
#define	TESTCODE_BLE_220V					COMPILE_ENABLE		//attention
...
//BLE_E & BLE_G & BLE_J
#define PCB_VERSION				BLE_E           //last version is BLE_E

//Commu_Mode_Common & Commu_Mode_OneCommu & Commu_Mode_TwoWire
#define Commu_Mode             	Commu_Mode_OneCommu            
#define Gear_Ratio_Motor        1				//Gear_Ratio_Motor > Gear_Ratio_Wheel
#define Gear_Ratio_Wheel        1
#define	Number_Pole_Pairs		23		//电机极对数
...
*		百事利三轮车专用轮胎为18英寸
*/
#define	Wheel_Diameter_Inch	    		16		
#define AH_Battery		       	 		20
#define	BatteryStandardM				40000
#define	Rated_Q_Release_PerFrame_A		(15) //等于额定AH*额定速度/额定公里数	两轮车额定速度一般是30km/h	
...
#define FirmwareVersion					0x010027	
...
/********************Feature  Configure*****************************/
	...
	#define		Double_LV						COMPILE_DISABLE
	#define		OneKeyRepair					COMPILE_DISABLE
