#ifndef __CUSTOMERL063008AA_H  
#define __CUSTOMERL063008AA_H
...
#define	Battery_Materials		MnNiCo_Ternary_Battery
	...
	#define Battery_Section_Num						16		//60V 用16节  48V用13节
#else
#endif
...
#define Gear_Ratio_Motor        10				//Gear_Ratio_Motor > Gear_Ratio_Wheel
...
*		百事利三轮车专用轮胎为18英寸
*/
#define	Wheel_Diameter_Inch	    		19		
#define AH_Battery		       	 		36
#define	BatteryStandardM				60000
#define	Rated_Q_Release_PerFrame_A		(11) //等于额定AH*额定速度/额定公里数	两轮车额定速度一般是30km/h	
