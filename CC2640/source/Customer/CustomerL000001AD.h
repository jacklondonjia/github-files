#ifndef __CUSTOMERL000001AD_H  
#define __CUSTOMERL000001AD_H
...
#define	Battery_Materials_InFlash		MnNiCo_Ternary_Battery
	...
	#define Battery_Section_Num						20		//72V用20节 60V用16节  48V用13节
#else
#endif
...
#define	Wheel_Diameter_Inch_Dec_InFlash				50
#define AH_Battery_InFlash		       	 		20
#define	BatteryStandardM_InFlash				40000
#define	Rated_Q_Release_PerFrame_A_InFlash		(15) //等于额定AH*额定速度/额定公里数	两轮车额定速度一般是30km/h	
