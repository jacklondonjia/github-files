#ifndef __CUSTOMERL064002AC_H  
#define __CUSTOMERL064002AC_H  
...
#define AH_Battery_InFlash		       	 			60
#define	BatteryStandardM_InFlash					150000
#define	Rated_Q_Release_PerFrame_A_InFlash			(12) //等于额定AH*额定速度/额定公里数	两轮车额定速度一般是30km/h	
