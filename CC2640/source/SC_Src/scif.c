...
static const uint16_t pAuxRamImage[] = {
    ...
    /*0x00C0*/ 0x6436, 0xBDB7, 0x241A, 0xA6FE, 0xADB7, 0x641A, 0xADB7, 0x0000, 0x0079, 0x007C, 0x009E, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000, 
    /*0x00E0*/ 0x0000, 0x0000, 0x0000, 0x0005, 0x0007, 0x0006, 0x0000, 0x0000, 0x0000, 0x0001, 0x0C67, 0xADB7, 0x7009, 0x1462, 0xFB4D, 0x8609, 
    /*0x0100*/ 0x7101, 0x6431, 0x2531, 0xA6FE, 0xFB00, 0x7018, 0xFB4C, 0x7003, 0xFB4C, 0xFD47, 0xFB4C, 0x1465, 0x0000, 0x6073, 0xFF1E, 0x14A5, 
    /*0x0120*/ 0x6403, 0x601F, 0xEB2C, 0xFDB1, 0xE902, 0x7076, 0xEF3F, 0x8801, 0x8A03, 0xAEF3, 0x14B2, 0x0001, 0x0C67, 0xADB7, 0xADB7, 0xFB0C, 
    /*0x0140*/ 0xEDA4, 0xEB09, 0x640B, 0xCDB1, 0xADB7, 0xF007, 0x1462, 0x86FF, 0x63F8, 0xEB51, 0x8680, 0x6000, 0xED8F, 0xEB49, 0xFD47, 0xEB49, 
    /*0x0160*/ 0x1465, 0xADB7, 0x1462, 0x7079, 0xFB55, 0x71FB, 0xFB54, 0xFD47, 0xFB54, 0x1465, 0x4431, 0x4400, 0xADB7
};
...
//  cfg         input       output      state       
    0x003010E6, 0x00000000, 0x003010EC, 0x00000000  // ad Scan
};
...
void scifReinitTaskIo(uint32_t bvTaskIds) {
    if (bvTaskIds & (1 << SCIF_AD_SCAN_TASK_ID)) {
        scifReinitIo(5, -1);
        scifReinitIo(7, -1);
        scifReinitIo(6, -1);
    }
