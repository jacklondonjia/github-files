/** \mainpage Driver Overview
  ...
  * Studio tool:
  * - <b>Project name</b>:     RGZ Worker
  * - <b>Project file</b>:     C:/Users/User/Documents/Texas Instruments/Sensor Controller Studio/examples/rgz_worker/rgz_worker.scp
  * - <b>Code prefix</b>:      -
  * - <b>Operating system</b>: TI-RTOS
  * - <b>Tool version</b>:     1.2.1.40829
  * - <b>Target chip</b>:      CC2640, revision -, package QFN48 7x7 RGZ
  * - <b>Created</b>:          2016-09-10 17:13:43.249
  * - <b>Computer</b>:         SHIJIA
  * - <b>User</b>:             User
  *
  ...
  * - ad Scan:
  *     - <b>A: Analog sensor output 0</b>: DIO25
  *     - <b>A: Analog sensor output 1</b>: DIO23
  *     - <b>A: Analog sensor output 2</b>: DIO24
  *
  *
  ...
  *
  *
  * \subsection section_task_desc_ad_scan ad Scan
...
/// ad Scan: Task ID
#define SCIF_AD_SCAN_TASK_ID 0


/// ad Scan: count of channels
#define SCIF_AD_SCAN_SENSOR_OUTPUT_COUNT 3
/// ad Scan I/O mapping: Analog sensor output
#define SCIF_AD_SCAN_DIO_ASENSOR_OUTPUT { 25, 23, 24 }
...
/// ad Scan: Task configuration structure
typedef struct {
    uint16_t pAuxioASensorOutput[3]; ///< I/O mapping: Analog sensor output
} SCIF_AD_SCAN_CFG_T;


/// ad Scan: Task output data structure
typedef struct {
    uint16_t pSamples[3]; ///< ADC sample buffer
} SCIF_AD_SCAN_OUTPUT_T;


/// Sensor Controller task data (configuration, input buffer(s), output buffer(s) and internal state)
typedef struct {
    struct {
        SCIF_AD_SCAN_CFG_T cfg;
        SCIF_AD_SCAN_OUTPUT_T output;
    } adScan;
} SCIF_TASK_DATA_T;
